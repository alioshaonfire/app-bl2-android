...
public class BhPhotoProductPageParser implements ProductPageParser {

    private static final String QUERY_GET_CANONICAL_URL = "document.querySelector(\"link[rel='canonical']\").href";
    private static final String QUERY_GET_ASIN = "document.querySelector(\"#ftSelectAsin\").value";

    private static final String STORE_NAME = "bhphotovideo";
    private static final String STORE_DOMAIN = "bhphotovideo.com";
